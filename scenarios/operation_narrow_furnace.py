...
# Generated by Mission Generator v2; RNG seed: narrow-furnace-turn-6-approved-contract
from math import *


def ScenarioInfo():
    d = dict()
    d['name'] = "Operation Narrow Furnace"
    d['description'] = """Two hours after Operation Resolute Passage, the intact six-ship sealift is committed west through Hormuz. BLUE holds temporary air superiority but its first-line CAP is recovering, Wildcat 2 is lost, and Wildcat 1 is under repair. Iran's original airborne package was destroyed, but its coastal kill chain and all nine surface combatants remain operational after correction of the previous route-convergence artifact. The coalition is now authorized to suppress the named corridor-control nodes, not to conduct a general attack on Iran.

Mission archetype: Corridor Opening. This scenario was generated from campaign turn 6 with deterministic seed narrow-furnace-turn-6-approved-contract."""
    d['author'] = 'Mission Generator v2'
    d['playableSides'] = "Blue"
    d['thumb'] = 'ships3.png'
    d['date'] = "May 2026"
    d['unitCount'] = 51
    d['scenarioId'] = "narrow_furnace_001"
    return d
...
def CreateScenario(SM):
    ...
    SM.SetDateTime(2026, 5, 22, 16, 30, 0)
    SM.SetSeaState(3)
...
Two hours after Operation Resolute Passage, the intact six-ship sealift is committed west through Hormuz. BLUE holds temporary air superiority but its first-line CAP is recovering, Wildcat 2 is lost, and Wildcat 1 is under repair. Iran's original airborne package was destroyed, but its coastal kill chain and all nine surface combatants remain operational after correction of the previous route-convergence artifact. The coalition is now authorized to suppress the named corridor-control nodes, not to conduct a general attack on Iran.

<color=#00a8ff>MISSION</color>

Preserve at least 5 of: RFA Fort Victoria, RFA Tidespring, USNS Amelia Earhart, USNS Cesar Chavez, USNS Guadalupe, USNS John Ericsson. Also Neutralize at least 3 of: Bastion 1, Bastion 2, Bastion 3, Coastwatch 1, S-300 Site North. Also Neutralize at least 2 of: Falakhon, Khanjar.

<color=#00a8ff>EXECUTION</color>

Lead with the MCM pair, keep the auxiliaries in two protected columns, use the outer escort lanes to defeat missile and surface attacks, hold Lancer at standoff until targets are positively designated, and preserve the fresh Tiger CAP for threats to the convoy and strike package.

<color=#00a8ff>ROE</color>

BLUE preplanned shore attack is limited to Bastion 1, Bastion 2, Bastion 3, S-300 Site North, and Coastwatch 1. Pantsir systems may be engaged in self-defense or when directly protecting an authorized target. Bandar Abbas Strip and the staged Shahin aircraft are not preauthorized targets. Neither side is authorized to expand the operation beyond the Hormuz corridor.

<color=#00a8ff>ASSESSMENT</color>

Generated difficulty ratio: 0.937.""")
...
Neutralize at least 2 of: RFA Fort Victoria, RFA Tidespring, USNS Amelia Earhart, USNS Cesar Chavez, USNS Guadalupe, USNS John Ericsson.

<color=#00a8ff>EXECUTION</color>

Use depleted eastern pickets to force early classification and weapons expenditure, then combine the western missile ambush with the intact coastal network against the logistics columns. Keep the Shahin reserve staged unless the crisis expands.
...
Generated difficulty ratio: 0.937.""")
    ...
    unit.SetPosition(25.550000, 56.950000, 7600.000000)
    unit.heading = 285.000000
    ...
    UI.add_waypoint_advanced(25.920000, 56.780000, 7600.000000, 390.000000)
    UI.add_waypoint_advanced(26.250000, 56.620000, 7600.000000, 390.000000)
    UI.add_waypoint_advanced(26.100000, 57.050000, 7600.000000, 390.000000)
    UI.add_waypoint_advanced(24.248000, 54.547000, 3000.000000, 360.000000)

    unit = SM.GetDefaultUnit()
    unit.className = "F-15E"
    unit.unitName = "Lancer 2"
    unit.SetPosition(25.500000, 57.020000, 7600.000000)
    unit.heading = 285.000000
    unit.speed = 390.000000
    unit.cost = 0.0
    SM.AddUnitToAlliance(unit, 1)
    ...
    UI.AddTask("AirEvade", 2.000000, 3)
    UI.AddTask("Nav", 3.000000, 3)
    UI.add_waypoint_advanced(25.870000, 56.830000, 7600.000000, 390.000000)
    UI.add_waypoint_advanced(26.200000, 56.680000, 7600.000000, 390.000000)
    UI.add_waypoint_advanced(26.050000, 57.120000, 7600.000000, 390.000000)
    UI.add_waypoint_advanced(24.248000, 54.547000, 3000.000000, 360.000000)
    ...
    UI.AddTask("ShipDefense", 2.000000, 3)
    UI.AddTask("Nav", 3.000000, 3)
    UI.add_waypoint_advanced(25.400000, 57.950000, 0.000000, 12.000000)
    UI.add_waypoint_advanced(25.550000, 57.750000, 0.000000, 12.000000)
    UI.add_waypoint_advanced(25.350000, 58.050000, 0.000000, 12.000000)
    ...
    SM.AddToUnitMagazine(unit.unitName, "DIFAR (110) Sonobuoy", 608)
    SM.AddToUnitMagazine(unit.unitName, "Flare-1", 75)
    SM.AddToUnitMagazine(unit.unitName, "Fuel", 39843)
    SM.AddToUnitMagazine(unit.unitName, "LOFAR (110) Sonobuoy", 203)
    SM.AddToUnitMagazine(unit.unitName, "Mk-50", 2)
    SM.AddToUnitMagazine(unit.unitName, "Mk-54", 34)
    SM.AddToUnitMagazine(unit.unitName, "BGM-109 TLAM", 36)
    ...
    # STAGED: Tiger 1
    SM.AddUnitToFlightDeck("USS George H.W. Bush", "F/A-18F", "Tiger 1", 1)
    SM.SetFlightDeckUnitLoadout("USS George H.W. Bush", "Tiger 1", "1 1400 liter tank;4 20mm PGU;1 AIM-9X;2 Chaff-1;2 Flare-1;")

    # STAGED: Tiger 2
    SM.AddUnitToFlightDeck("USS George H.W. Bush", "F/A-18F", "Tiger 2", 1)
    SM.SetFlightDeckUnitLoadout("USS George H.W. Bush", "Tiger 2", "1 1400 liter tank;4 20mm PGU;1 AIM-9X;2 Chaff-1;2 Flare-1;")

    # STAGED: Viper 1
    SM.AddUnitToFlightDeck("Al Dhafra Air Base", "F-15E", "Viper 1", 1)
    SM.SetFlightDeckUnitLoadout("Al Dhafra Air Base", "Viper 1", "4 20mm PGU;1 600 gallon tank;1 AIM-120D;1 AIM-9X;12 Chaff-1;12 Flare-1;")

    # STAGED: Viper 2
    SM.AddUnitToFlightDeck("Al Dhafra Air Base", "F-15E", "Viper 2", 1)
    SM.SetFlightDeckUnitLoadout("Al Dhafra Air Base", "Viper 2", "4 20mm PGU;1 600 gallon tank;1 AIM-120D;1 AIM-9X;12 Chaff-1;12 Flare-1;")

    # MAINTENANCE: Wildcat 1
    SM.AddUnitToFlightDeck("Al Dhafra Air Base", "F-15E", "Wildcat 1", 1)
    SM.SetFlightDeckUnitLoadout("Al Dhafra Air Base", "Wildcat 1", "46 20mm PGU;2 AIM-120D;2 AIM-9X;120 Chaff-1;120 Flare-1;4 GBU-12/B;2 GBU-31A(v)2;8 GBU-39 SDB;")
    ...
    unit.SetPosition(26.420000, 55.740000, 0.000000)
    ...
    UI.AddTask("AutoAttack", 3.000000, 0)
    UI.AddTask("Nav", 4.000000, 3)
    UI.add_waypoint_advanced(26.420000, 56.020000, 0.000000, 22.000000)
    UI.add_waypoint_advanced(26.420000, 56.200000, 0.000000, 22.000000)
    UI.add_waypoint_advanced(26.410000, 56.340000, 0.000000, 22.000000)
    ...
    UI.AddTask("AutoAttack", 3.000000, 0)
    UI.AddTask("Nav", 4.000000, 3)
    UI.add_waypoint_advanced(26.350000, 56.570000, 0.000000, 18.000000)
    UI.add_waypoint_advanced(26.210000, 56.700000, 0.000000, 18.000000)
    UI.add_waypoint_advanced(26.070000, 56.820000, 0.000000, 18.000000)

    unit = SM.GetDefaultUnit()
    unit.className = "Moudge FFG"
    unit.unitName = "IRIS Dena"
    unit.SetPosition(26.470000, 55.780000, 0.000000)
    unit.heading = 90.000000
    unit.speed = 18.000000
    unit.cost = 0.0
    SM.AddUnitToAlliance(unit, 2)
    ...
    UI.AddTask("AutoAttack", 3.000000, 0)
    UI.AddTask("Nav", 4.000000, 3)
    UI.add_waypoint_advanced(26.470000, 56.060000, 0.000000, 18.000000)
    UI.add_waypoint_advanced(26.470000, 56.240000, 0.000000, 18.000000)
    UI.add_waypoint_advanced(26.460000, 56.380000, 0.000000, 18.000000)

    unit = SM.GetDefaultUnit()
    unit.className = "Moudge FFG"
    unit.unitName = "IRIS Sahand"
    unit.SetPosition(26.520000, 55.820000, 0.000000)
    unit.heading = 90.000000
    unit.speed = 18.000000
    unit.cost = 0.0
    SM.AddUnitToAlliance(unit, 2)
    ...
    UI.AddTask("ShipDefense", 2.000000, 3)
    UI.AddTask("Nav", 3.000000, 3)
    UI.add_waypoint_advanced(26.520000, 56.100000, 0.000000, 18.000000)
    UI.add_waypoint_advanced(26.520000, 56.280000, 0.000000, 18.000000)
    UI.add_waypoint_advanced(26.500000, 56.400000, 0.000000, 18.000000)
    ...
    SM.AddUnitToAlliance(unit, 2)
    SM.SetUnitAlwaysVisibleState(unit.unitName, 1)
    SM.SetUnitLauncherItem(unit.unitName, 0, "48N6E2", 2)
    SM.SetUnitLauncherItem(unit.unitName, 1, "48N6E2", 2)
    SM.SetUnitLauncherItem(unit.unitName, 2, "48N6E2", 2)
    ...
    UI.AddTask("ShipDefense", 2.000000, 3)
    UI.AddTask("Nav", 3.000000, 3)
    UI.add_waypoint_advanced(26.270000, 55.900000, 0.000000, 20.000000)
    UI.add_waypoint_advanced(26.270000, 56.040000, 0.000000, 20.000000)
    UI.add_waypoint_advanced(26.280000, 56.120000, 0.000000, 20.000000)
    ...
    UI.AddTask("AutoAttack", 3.000000, 0)
    UI.AddTask("Nav", 4.000000, 3)
    UI.add_waypoint_advanced(26.220000, 55.860000, 0.000000, 20.000000)
    UI.add_waypoint_advanced(26.220000, 55.980000, 0.000000, 20.000000)
    UI.add_waypoint_advanced(26.240000, 56.060000, 0.000000, 20.000000)
    ...
    # STAGED: Shahin 1
    SM.AddUnitToFlightDeck("Bandar Abbas Strip", "F-14A", "Shahin 1", 2)
    SM.SetFlightDeckUnitLoadout("Bandar Abbas Strip", "Shahin 1", "46 20mm PGU;4 AIM-54A;2 AIM-7E;2 AIM-9P;30 Chaff-1;30 Flare-1;")

    # STAGED: Shahin 2
    SM.AddUnitToFlightDeck("Bandar Abbas Strip", "F-14A", "Shahin 2", 2)
    SM.SetFlightDeckUnitLoadout("Bandar Abbas Strip", "Shahin 2", "46 20mm PGU;4 AIM-54A;2 AIM-7E;2 AIM-9P;30 Chaff-1;30 Flare-1;")
